...
![Push Text Files](./images/1.webp)

아래와 같이 Github Action이 돌아갑니다.

![Github Action이 돌아갑니다](./images/2.webp)

최종적으로 이미지 파일이 만들어 졌습니다.
![github-action-image-generation](./images/3.webp)

"와우.png"
![github-action-image-generation-1](./images/4.webp)
