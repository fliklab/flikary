...
![(스크린샷) 키체인접근 실행](./images/1.webp)

'github.com'을 검색하면 목록에 여러 항목이 나타난다.

![(스크린샷) Keychain Access에서 github.com 검색](./images/2.webp)

![(스크린샷) Keychain Access](./images/3.webp)
...
![접근 제어에서 `git-credential-osxkeychain`가 있는지 확인](./images/4.webp)

다시 "속성" 탭으로 되돌아가서 비밀번호를 입력하는 칸에 Personal AccessToken을 입력해주고 변경사항을 저장한다.

![(스크린샷) Keychain Access에서 Personal AccessToken 입력](./images/5.webp)
