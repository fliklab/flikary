...
works:
  - company: (주)볼라
    ...
    description: |
      React Native 기반의 라이브 커머스 플랫폼인 와이스(WYYYES)와 볼라(서비스 종료) 등의 앱 프론트엔드 개발을 담당하였습니다. 팀 초기 멤버로 비즈니스 목표를 함께 달성해 왔습니다.
    ...
    projects:
      - name: 와이스(WYYYES)
        ...
        description:
          ...
          - 라이브 스트리밍, 실시간 경매 시스템, 채팅 시스템, 배송 시스템 등 개발
...
- **React.js와 React Native**를 활용하여 웹과 모바일을 아우르는 크로스플랫폼 개발 경험을 가지고 있으며, 크로스플랫폼 개발에 대한 전문성을 갖추고 있습니다.
- GitHub Actions, Fastlane, shell script 등을 활용한 **CI/CD** 및 개발 효율성을 높이기 위한 자동화 경험이 있습니다.
- Next.js 기반 SSR, SSG, 메타 태그 최적화, 성능 최적화 등의 **SEO를 통해 검색엔진 상위 노출을 달성한 경험**이 있습니다.
